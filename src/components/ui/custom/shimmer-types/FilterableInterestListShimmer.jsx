...
const FilterableInterestListShimmer = ({
  itemCount = 5,
  showSearchBar = true,
  ...props
}) => {
  ...
  const InterestItemShimmer = ({ index }) => (
    <motion.div
      custom={index}
      ...
      <div className="relative p-5">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center flex-1">
            ...
            <div className="ml-4 flex-1">
              {/* Interest period shimmer - khớp với h4 font-semibold text-base */}
              <div className="w-32 h-5 bg-gray-200 rounded mb-1 relative overflow-hidden">
                <motion.div
                  variants={shimmerVariants}
                  initial="initial"
                  animate="animate"
          ...
          <div className="text-right">
            <div className="w-28 h-6 bg-gray-200 rounded mb-1 relative overflow-hidden">
              <motion.div
                variants={shimmerVariants}
                initial="initial"
                animate="animate"
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            {/* Method value - khớp với bg-gray-50 px-3 py-1 rounded-full */}
          ...
          <div className="w-16 h-3.5 bg-gray-200 rounded relative overflow-hidden">
            ...
            {/* Status badge - khớp với emerald styling (có thể là emerald hoặc amber) */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border bg-amber-50 border-amber-200">
              <div className="w-3.5 h-3.5 bg-gray-200 rounded relative overflow-hidden">
                <motion.div
                  variants={shimmerVariants}
                  initial="initial"
          ...
          {/* Bottom section shimmer - khớp với Clock icon + interest rate + Chi tiết button */}
          <div className="flex items-center justify-between text-sm pt-2 border-t border-gray-100">
            <div className="flex items-center gap-2">
              ...
              {/* Interest rate text - khớp với "Lãi suất: X%/năm" */}
  ...
  return (
    <AnimatePresence>
      <div className="space-y-6 pb-44 md:pb-24">
        ...
        {/* Interest list shimmer */}
        <div className="space-y-4">
          {Array.from({ length: itemCount }, (_, index) => (
            <InterestItemShimmer key={index} index={index} />
          ))}
        </div>
...
export default FilterableInterestListShimmer;