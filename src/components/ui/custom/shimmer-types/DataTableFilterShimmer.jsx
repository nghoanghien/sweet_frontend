...
const DataTableFilterShimmer = ({
  ...
  return (
    <motion.div
      ...
      className="relative bg-gradient-to-br from-purple-50/80 to-white rounded-2xl shadow-[0_4px_24px_rgba(147,51,234,0.08)] mb-8 -mt-4 border border-purple-100"
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-purple-500 to-indigo-600 p-2.5 rounded-xl shadow-[0_4px_16px_rgba(147,51,234,0.18)] relative overflow-hidden"
            >
            ...
            <div>
              {/* Title shimmer */}
              <div className="w-40 h-4 bg-purple-200 rounded relative overflow-hidden mb-1">
                <motion.div
                  variants={shimmerVariants}
                  initial="initial"
                  animate="animate"
              ...
              {/* Subtitle shimmer */}
              <div className="w-56 h-3 bg-purple-100 rounded relative overflow-hidden">
                <motion.div
                  variants={shimmerVariants}
                  initial="initial"
                  animate="animate"
          ...
          <div className="flex items-center space-x-3">
            ...
            <motion.div
              ...
              className="bg-purple-100 p-2 rounded-full relative overflow-hidden"
            >
        ...
        {isExpanded && (
          ...
          >
            <div className="px-6 pb-6 relative z-10">
              ...
              >
                {/* Filter Section 1 - Status Filter */}
                <div className="bg-white rounded-2xl border border-purple-100 shadow-md overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-purple-100 to-indigo-100 px-6 py-4 border-b border-purple-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="w-20 h-3 bg-purple-200 rounded relative overflow-hidden">
                        <motion.div
                          variants={shimmerVariants}
                          initial="initial"
                          animate="animate"
                  ...
                  <div className="p-6">
                    <div className="flex flex-wrap gap-3">
                      {Array.from({ length: 3 }, (_, index) => (
                        <div key={index} className="px-5 py-3 rounded-xl bg-gray-100 relative overflow-hidden">
                ...
                <div className="flex-1">
                  <div className="bg-white rounded-2xl border border-purple-100 shadow-md">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-purple-100 to-indigo-100 px-6 py-2 border-b border-purple-100 rounded-t-2xl">
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full"></div>
                        <div className="w-24 h-3 bg-purple-200 rounded relative overflow-hidden">
                          <motion.div
                            variants={shimmerVariants}
                            initial="initial"
                            animate="animate"
...
export default DataTableFilterShimmer;